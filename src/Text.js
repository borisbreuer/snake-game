...
export default class Text {
  constructor(text) {
    this.txt = text;
    this.tWidth = c.measureText(text).width / 2;
    this.gradient;
  }
  ...
  draw() {
    ...
    this.gradient.addColorStop("0", "rgb(0, 200, 0)");
    this.gradient.addColorStop("0.5", "rgb(255, 127, 0)");
    this.gradient.addColorStop("1", "rgb(0, 200, 0)");
